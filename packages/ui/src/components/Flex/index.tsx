...
const Flex = styled.div<FlexProps>((props) => {
  const alignFlag = (Object.keys(alignOptions).find((key) =>
    Object.hasOwn(props, key)
  ) || "align-start") as AlignFlags;
  const justifyFlag = (Object.keys(justifyOptions).find((key) =>
    Object.hasOwn(props, key)
  ) || "justify-start") as JustifyFlags;
  const directionFlag = (Object.keys(directionOptions).find((key) =>
    Object.hasOwn(props, key)
  ) || "row") as DirectionFlags;
